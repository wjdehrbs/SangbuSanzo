...
import com.example.sangbusanzo.data.TeamMemberData
...
class MainPage : AppCompatActivity() {
    ...
    private val setting by lazy {
        findViewById<ImageView>(R.id.setting)
    }
    private val scrollView by lazy {
        findViewById<ScrollView>(R.id.scrollview_friends)
    }
    private val notificationCloseButton by lazy {
        findViewById<ImageButton>(R.id.close_button)
    }
    private val notification by lazy {
        findViewById<CardView>(R.id.main_notification)
    }
    private val notificationTextView by lazy {
        notification.findViewById<TextView>(R.id.notification_text)
    }
    private val cardViewMain by lazy {
        findViewById<CardView>(R.id.main_profile)
    }
    private val cardViewFirst by lazy {
        findViewById<CardView>(R.id.main_friend_1)
    }
    private val cardViewSecond by lazy {
        findViewById<CardView>(R.id.main_friend_2)
    }
    private val cardViewThird by lazy {
        findViewById<CardView>(R.id.main_friend_3)
    }
    private val cardViewFourth by lazy {
        findViewById<CardView>(R.id.main_friend_4)
    }
    ...
    private val notLoggedInTextView by lazy {
        findViewById<TextView>(R.id.not_logged_in)
    }
